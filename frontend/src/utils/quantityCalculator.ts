 ...
 * Antibiotics typically 7-10 days, chronic meds 30-90 days, etc.
 */
export function getDefaultDuration(medicationName: string): number {
  const name = medicationName.toLowerCase();

  // Antibiotics: typically 7-10 days
  if (
  ...
  // Short-term steroids: 5-7 days
  if (name.includes('prednisone')) {
    return 7;
  }

  // PRN medications: 30 days
  if (
